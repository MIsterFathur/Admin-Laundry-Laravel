                ...
                <div class="">
                  ...
                  <form class="user" action="{{route('proceed-login')}}" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-user" name="username" autocomplete="off"
                        required="" autofocus="">
                    </div>
                    <div class="form-group">
                      <label>Password</label>
                      <input type="password" class="form-control form-control-user" autocomplete="off" name="password"
                        required="">
                    </div>
                    <button type="submit" class="btn btn-primary btn-user btn-block" style="margin-top:10px">
                      Login
                    </button>
                  </form>
