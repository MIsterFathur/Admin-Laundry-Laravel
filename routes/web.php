...
Route::post('login', [LoginController::class, 'login'])->name('proceed-login');
...
Route::middleware(['auth'])->group(function () {
    ...
    // Route::get('/customer/get', 'CustomerController@getCustomer')->name('customer.getCustomer');
    ...
    Route::get('/get-customer', [CustomerController::class, 'getCustomer'])->name('customer.getCustomer');
